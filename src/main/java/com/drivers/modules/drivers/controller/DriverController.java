...
public class DriverController {
    ...
    public Page<DriverDebtDto> getAllDebts(@PageableDefault(size = 20, direction = Sort.Direction.DESC, sort = "totalDebt") Pageable pageable) {
        return driverService.getAllDebts(pageable);
    }
}